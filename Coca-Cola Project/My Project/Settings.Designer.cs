...
namespace Coca_Cola_Project.My
{
    ...
    internal sealed partial class MySettings : System.Configuration.ApplicationSettingsBase
    {
        ...
        */
        ...
        [System.Configuration.DefaultSettingValue(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\FreeStyleDB.m" + "df;Integrated Security=True")]

        public string FreeStyleDBConnectionString
        {
            get
            {
                return Conversions.ToString(this["FreeStyleDBConnectionString"]);
            }
        }
    }
}
